...
type HelpRepository interface {
	GetHelpsByStudentID(studentID int64, limit int, offset int) (total int64, helps model.Helps, err error)
	GetHelpsByLectureID(lectureID int64, limit int, offset int) (total int64, helps model.Helps, err error)
