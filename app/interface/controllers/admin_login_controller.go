...
func NewAdminLoginController(userRepository repository.UserRepository, output port.AuthOutput, validator validator.Validation) (*AdminLoginController, error) {
